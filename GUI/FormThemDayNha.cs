...
namespace GUI
{
    ...
    public partial class FormThemDayNha : Form
    {
        UserBLL userBLL;
        DayNhaBLL daynha;
        ...
        int idNha = 0;
        public FormThemDayNha(string nameLable, string nameBtn, int idNha)
        {
            InitializeComponent();
            userBLL = new UserBLL();
        ...
        private void BtnAddDayNha_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                GiaDienNuocDTO dgn = new GiaDienNuocDTO(
                    daynha.FindByFullInfo(dn).HostelID,
                    decimal.Parse(txtGiaDien.Text),
                    decimal.Parse(txtGiaNuoc.Text),
                    DateTime.Now,
                    true
